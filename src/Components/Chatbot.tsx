  ...
  return (
    <div className="flex flex-col max-w-md mx-auto p-8 bg-white rounded shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="w-full py-2 bg-slate-700 px-4 bg-blue-600 text-white rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          Submit
        </button>
      </form>
